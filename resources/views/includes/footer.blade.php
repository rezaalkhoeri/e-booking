    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-12 mb-md-0 mb-4">
                <h2 class="footer-heading"><a href="#" class="logo">E Service Center PDSI</a></h2>
                <p>Website booking ruangan meeting PT Pertamina Drilling Services Indonesia</p>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-8">
                    ...
                    <p class="copyright mb-0">
                        ...
                        </script> All rights reserved | <a href="https://pdsi.pertamina.com" target="_blank"> PT Pertamina Drilling Services Indonesia</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
